      ...
      <div class="c-display">
        ...
        <div class="info-and-operate">
          <div class="info">
            <div class="info-top">
              ...
              <div class="info-top-right">
                ...
                <el-button style='height:35px' size="small" @click='copy(listData[focusModeDisplayIndex].openid)'>复制openid</el-button>
              </div>
            </div>
            <div class="info-btm" style='marginTop:16px'>
          ...
          <div class="operate">
            ...
            <el-button style='marginLeft:88px' type="success" @click='approvalList(unqualifiedArr)' :disabled="userType!==5">本页全合格</el-button>
            <div class="operate-btm">
              <div class="operate-btm-left">
                <span class="span1" @click='PageUp'>Page UP</span>
                <span @click='PageDown' class="span2">Page Down</span>
                <img class="qqqq" @click='PageUp' src="../../../assets/imgs/arrow.png" alt="" />
                <img style='marginTop:20px' @click='PageDown' class="wwww wow" src="../../../assets/imgs/arrow.png" alt="" />
              </div>
              <div class="operate-btm-right">
                <el-button style='width:84px' :disabled="userType!==5" @click='approval(2,listData[focusModeDisplayIndex])' v-show='listData[focusModeDisplayIndex].status===1 || listData[focusModeDisplayIndex].status===0' size="big" type="success">合格</el-button>
                <el-button :class="listData[focusModeDisplayIndex].status!==0?'qwer':''" style='width:84px' class="aaa" :disabled="userType!==5" @click='approval(1,listData[focusModeDisplayIndex])' v-show='listData[focusModeDisplayIndex].status===2 || listData[focusModeDisplayIndex].status===0' size="big" type="danger">不合格</el-button>
              </div>
            </div>
          </div>
        </div>
